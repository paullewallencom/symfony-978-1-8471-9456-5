...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/timmy/workspace/milkshake/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/timmy/workspace/milkshake/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/timmy/workspace/milkshake/apps/frontend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/timmy/workspace/milkshake/cache/frontend/dev/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/home/timmy/workspace/milkshake/apps/frontend/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  {
    $class = sfConfig::get('sf_factory_view_cache', 'sfMemcacheCache');
    $cache = new $class(sfConfig::get('sf_factory_view_cache_parameters', array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/timmy/workspace/milkshake/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => 'frontend',
  'storeCacheInfo' => true,
)));
